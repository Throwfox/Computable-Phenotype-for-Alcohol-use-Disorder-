...
*   **`Population_identified_drugs.py`**: Identifies patients based on AUD-related medication prescriptions.
...
*   **`Population_identified_ICD.py`**: Identifies patients based on ICD-9 and ICD-10 diagnosis codes.
...
*   **`Population_identified_keywords.py`**: Processes clinical notes to identify AUD-related keywords.
...
*   **`Implementation.ipynb`**: The main analysis notebook.
...
2.  **Run Extraction Scripts**:
    ...
    ```bash
    python Population_identified_drugs.py
    python Population_identified_ICD.py
    python Population_identified_keywords.py
    ```

3.  **Run Analysis**:
    Open `Implementation.ipynb` in Jupyter Notebook to perform the overlap analysis and view the final phenotype statistics.
